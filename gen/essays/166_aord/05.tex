...
{[}\hyperref[f1n]{1}{]} But investors are so fickle that you can never
...
killer of startups that raise money. {[}\hyperref[f2n]{2}{]}
...
and that's usually easier with fewer people. {[}\hyperref[f4n]{4}{]}
...
{[}1{]} Steep usage growth will also interest investors. Revenue will
...
{[}2{]} Startups that don't raise money are saved from hiring too fast
...
{[}3{]} I would not be surprised if VCs' tendency to push founders to
