...
{[}1{]} The closest thing to an exception is when you have to go back
...
{[}2{]} Obviously if you shake the bin hard enough the objects in it can
...
{[}3{]} Bizarrely enough, this happened in the writing of this very
