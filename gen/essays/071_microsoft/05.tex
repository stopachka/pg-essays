...
{[}\hyperref[f1n]{1}{]} But eventually the open source world won, by
...
in technology. {[}\hyperref[f2n]{2}{]} Their victory is so complete that
...
{[}1{]} It doesn't take a conscious effort to make software
...
{[}2{]} In part because Steve Jobs got pushed out by John Sculley in a
