...
maybe charge for premium features. {[}\hyperref[f1n]{1}{]}
...
population, and you have zero users. {[}\hyperref[f2n]{2}{]}
...
can't answer that, the idea is probably bad. {[}\hyperref[f3n]{3}{]}
...
you're also looking for a cofounder. {[}\hyperref[f4n]{4}{]}
...
sites would have to be generated by software. {[}\hyperref[f5n]{5}{]}
...
as a match for his skills. {[}\hyperref[f7n]{7}{]}
...
job in some unrelated field. {[}\hyperref[f8n]{8}{]}
...
that could be turned into a startup. {[}\hyperref[f10n]{10}{]} I think
...
(like Microsoft). {[}\hyperref[f12n]{12}{]}
...
on it more enthusiastically. {[}\hyperref[f13n]{13}{]}
...
\emph{must} be things you need. {[}\hyperref[f14n]{14}{]}
...
while they were working at their day jobs. {[}\hyperref[f15n]{15}{]}
...
reached the bottom of the well. {[}\hyperref[f16n]{16}{]}
...
{[}1{]} This form of bad idea has been around as long as the web. It was
...
{[}5{]} It was also obvious to us that the web was going to be a big
deal. Few non-programmers grasped that in 1995, but the programmers had
seen what GUIs had done for desktop computers.

{[}6{]} Maybe it would work to have this second self keep a journal, and
...
{[}7{]} Sam Altman points out that taking time to come up with an idea
...
{[}8{]} For the computer hardware and software companies, summer jobs
...
{[}9{]} The empirical evidence suggests that if colleges want to help
...
{[}12{]} In practice most successful startups have elements of both. And
...
{[}14{]} The need has to be a strong one. You can retroactively describe
...
{[}15{]} Paul Buchheit points out that trying to sell something bad can
...
{[}16{]} Here's a recipe that might produce the next Facebook, if you're
...
{[}17{]} And the reason it used a TV for a monitor is that Steve Wozniak
