...
empire had little practical effect. {[}\hyperref[f2n]{2}{]}
...
alternative if you made one. {[}\hyperref[f5n]{5}{]}
...
organizations for reaching audiences. {[}\hyperref[f6n]{6}{]}
...
ideologies.~{[}\hyperref[f8n]{8}{]} But if you're an ambitious
...
to find ways to work on it. {[}\hyperref[f9n]{9}{]} It will also be
...
do about what's worth paying attention to. {[}\hyperref[f10n]{10}{]}
...
his contemporaries' combined. {[}\hyperref[f11n]{11}{]}
...
{[}4{]} Seeking competition could be a good heuristic in the sense that
...
{[}5{]} Not always, though. You have to be careful with this rule. When
...
{[}6{]} In my twenties I wanted to be an \href{worked.html}{artist} and
...
{[}7{]} In principle everyone is getting superlinear returns. Learning
...
will be hosing them even more than they have in the past.

{[}10{]} The original version of this paragraph was the first draft of
...
{[}11{]} Before the Industrial Revolution, people who got rich usually
