...
the next several months. {[}\hyperref[f2n]{2}{]}
...
those it doesn't, it at least keeps busy. {[}\hyperref[f3n]{3}{]}
...
{[}2{]} The same qualities that make fierce nerds so effective can also
...
{[}3{]} If success neutralizes bitterness, why are there some people who
