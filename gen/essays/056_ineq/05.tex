...
the rest is diminished\ldots. {[}\hyperref[f1n]{1}{]}
\end{quote}
...
{[}\hyperref[f3n]{3}{]} And while it would probably be a good thing for
...
or oil magnates did. {[}\hyperref[f6n]{6}{]} The great concentrations of
...
the underlying causes. {[}\hyperref[f7n]{7}{]}
...
the rich. {[}\hyperref[f8n]{8}{]} Indeed, a good number are merely being
...
hope that you will thereby fix poverty. {[}\hyperref[f9n]{9}{]} And if
...
it's stealing. {[}\hyperref[f10n]{10}{]}
...
{[}1{]} Stiglitz, Joseph. \emph{The Price of Inequality}. Norton, 2012.
p.~32.

{[}2{]} Particularly since economic inequality is a matter of outliers,
...
{[}3{]} Determination is the most important factor in deciding between
...
{[}4{]} After reading a draft of this essay, Richard Florida told me how
...
{[}5{]} Economic inequality has been decreasing globally. But this is
...
{[}6{]} Some people still get rich by buying politicians. My point is
that it's no longer a precondition.

{[}7{]} As well as problems that have economic inequality as a symptom,
...
{[}9{]} Particularly since many causes of poverty are only partially
