...
dominance hierarchy. {[}\hyperref[f1n]{1}{]} Plus having new ideas is
...
kind of thinking. {[}\hyperref[f4n]{4}{]}
...
{[}1{]} What wins in conversation depends on who with. It ranges from
...
probably always with some component of quick-wittedness.

{[}2{]} Just as intelligence isn't the only ingredient in having new
...
{[}3{]} Some would attribute the difference between intelligence and
...
{[}4{]} Curiously enough, this essay is an example. It started out as an
