...
One of the reasons to use Lisp in writing Web-based applications is that you _can_ use Lisp. When you're writing software that is only going to run on your own servers, you can use whatever language you want.
