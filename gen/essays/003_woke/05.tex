...
concerned with much the same issues. {[}\hyperref[f1n]{1}{]}
...
political as you like. {[}\hyperref[f2n]{2}{]}
...
artifact of the constraints imposed by print. {[}\hyperref[f8n]{8}{]}
...
{[}\hyperref[f9n]{9}{]} Meanwhile journalists, of a sort, had arisen to
...
language guide.'' {[}\hyperref[f10n]{10}{]}
...
there's no justification for their existence. {[}\hyperref[f11n]{11}{]}
...
the cycle accelerates. {[}\hyperref[f12n]{12}{]}
...
might be guilty of. {[}\hyperref[f13n]{13}{]}
...
without censoring either. {[}\hyperref[f14n]{14}{]} Consumers have
...
masses. {[}\hyperref[f15n]{15}{]} And we already have well-established
...
way about their religion. {[}\hyperref[f16n]{16}{]}
...
allowed to change what we're allowed to say. {[}\hyperref[f17n]{17}{]}
...
{[}\hyperref[f18n]{18}{]} And we couldn't prevent people from creating
...
{[}0{]} This was not the original meaning of ``woke,'' but it's rarely
used in the original sense now. Now the pejorative sense is the dominant
one.

{[}1{]} Why did 1960s radicals focus on the causes they did? One of the
...
{[}2{]} It helped that the humanities and social sciences also included
...
{[}3{]} The puppet-master-and-puppet character of political correctness
...
{[}4{]} The woke sometimes claim that wokeness is simply treating people
...
{[}5{]} In 1986 the Supreme Court ruled that creating a hostile work
...
{[}9{]} The Times made this momentous announcement very informally, in
...
that this particular universe ended with a whimper rather than a bang.
...
{[}12{]} The invention of new improprieties is most visible in the rapid
...
{[}13{]} Organizations that do dubious things are particularly concerned
...
{[}14{]} Elon did something else that tilted Twitter rightward though:
...
could tilt Twitter back to the left tomorrow if they wanted to.

{[}15{]} It even, as James Lindsay and Peter Boghossian pointed out, has
...
act are often revolted by the things done in their name.

{[}16{]} There is one exception to most of these rules: actual religious
...
{[}17{]} I don't want to give the impression that it will be simple to
