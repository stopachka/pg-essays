...
that everyone else took for granted. {[}\hyperref[f2n]{2}{]}
...
a bet as you'll find. {[}\hyperref[f3n]{3}{]}
...
ask lots of questions. {[}\hyperref[f5n]{5}{]}
...
a standard. Probably all three are true. {[}\hyperref[f11n]{11}{]}
...
orthodox, fashionable, or cool. {[}\hyperref[f14n]{14}{]}
...
enough just to go for a walk. {[}\hyperref[f16n]{16}{]}
...
something more like a power law. {[}\hyperref[f17n]{17}{]} Be
...
and Darwin both made discoveries of this type. {[}\hyperref[f18n]{18}{]}
...
that you don't want to solve them. {[}\hyperref[f20n]{20}{]}
...
possibly a better one than you think. {[}\hyperref[f23n]{23}{]}
...
superiority rather than subordination. {[}\hyperref[f25n]{25}{]}
...
your self-confidence. {[}\hyperref[f26n]{26}{]}
...
avoid such projects. {[}\hyperref[f27n]{27}{]}
...
adjacent type if that will let you go direct. {[}\hyperref[f28n]{28}{]}
...
they're good for thinking. {[}\hyperref[f29n]{29}{]}
...
{[}4{]} Finding something to work on is not simply a matter of finding a
...
{[}6{]} It can also be dangerous to make things for an audience you feel
...
{[}7{]} This idea I learned from Hardy's \emph{A Mathematician's
...
{[}12{]} This gets more complicated in work like acting, where the goal
...
{[}15{]} Obviously you don't have to be working at the exact moment you
...
{[}21{]} Derived from Linus Pauling's ``If you want to have good ideas,
...
{[}23{]} One way to tell whether you're wasting time is to ask if you're
...
{[}25{]} In the early 1630s Daniel Mytens made a painting of Henrietta
...
{[}29{]} It may be helpful always to walk or run the same route, because
