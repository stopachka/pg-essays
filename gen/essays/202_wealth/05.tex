...
{[}\hyperref[f1n]{1}{]} You should get another multiple of two, at
...
to be in a random corporate job. {[}\hyperref[f2n]{2}{]} If a fairly
...
Wealth is not the same thing as money. {[}\hyperref[f3n]{3}{]} Wealth is
...
not joining the group. {[}\hyperref[f6n]{6}{]}
...
{[}\hyperref[f7n]{7}{]} And you had better have a convincing explanation
...
not the one to make money from it. {[}\hyperref[f8n]{8}{]} The company
...
to collect in towns. {[}\hyperref[f10n]{10}{]} Together they were able
...
{[}\hyperref[f11n]{11}{]} One piece of evidence is what happened to
...
{[}2{]} Faced with the idea that people working for startups might be 20
...
{[}3{]} Until recently even governments sometimes didn't grasp the
...
{[}5{]} In the average car restoration you probably do make everyone
...
{[}7{]} When VCs asked us how long it would take another startup to
duplicate our software, we used to reply that they probably wouldn't be
able to at all. I think this made us seem naive, or liars.

{[}8{]} Few technologies have one clear inventor. So as a rule, if you
...
it's because other companies made all the money.
...
{[}10{]} It is probably no accident that the middle class first appeared
...
{[}11{]} It may indeed be a sufficient condition. But if so, why didn't
...
regulations initially slowed the development of new means of production.
