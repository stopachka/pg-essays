...
profitability is that it buys you time. {[}\hyperref[f1n]{1}{]}
...
{[}\hyperref[f3n]{3}{]} But it's pretty easy to make \$3000 a month
...
{[}1{]} The ``ramen'' in ``ramen profitable'' refers to instant ramen,
...
{[}2{]} There's a good chance that a shift in power from investors to
...
{[}3{]} It's conceivable that a startup could grow big by transforming
consulting into a form that would scale. But if they did that they'd
really be a product company.
