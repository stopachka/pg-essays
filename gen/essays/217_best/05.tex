...
was possible to make. {[}\hyperref[f1n]{1}{]}
...
the answer turns out to be completely different. {[}\hyperref[f3n]{3}{]}
...
and novelty are what make a branch exciting. {[}\hyperref[f5n]{5}{]}
...
moment. Go with it and see what you get. {[}\hyperref[f8n]{8}{]}
...
systematically. If only. {[}\hyperref[f9n]{9}{]}
...
knows about them. {[}\hyperref[f10n]{10}{]}
...
before they read them. {[}\hyperref[f11n]{11}{]}
...
{[}1{]} There might be some resistance to this conclusion on the grounds
...
{[}2{]} When you find yourself very curious about an apparently minor
...
{[}3{]} Corollary: If you're not intellectually honest, your writing
...
{[}5{]} The problem with this type of ``greedy'' algorithm is that you
...
{[}6{]} I ended up reattaching the first 5 of the 17 paragraphs, and
discarding the rest.
...
{[}8{]} Too far doesn't depend just on the distance from the original
topic. It's more like that distance divided by the value of whatever
I've discovered in the subtree.

{[}9{]} Or can you? I should try writing about this. Even if the chance
...
{[}12{]} If you'd asked me 10 years ago, I'd have predicted that schools
