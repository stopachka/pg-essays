...
Sending spam does cost the spammer something, though. {[}2{]} So the
...
{[}1{]} The examples in this article are translated into Common Lisp
...
{[}2{]} Currently the lowest rate seems to be about \$200 to send a
