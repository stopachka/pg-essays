...
unforgivable sins: crime, heresy, and marriage. {[}\hyperref[f1n]{1}{]}
\end{quote}
...
therefore false, when another person does. {[}\hyperref[f2n]{2}{]}
...
facto morally superior to anyone who doesn't. {[}\hyperref[f3n]{3}{]}
...
continue to increase. Instead it has decreased. {[}\hyperref[f5n]{5}{]}
...
not that high. The problem is the derivative. {[}\hyperref[f6n]{6}{]}
