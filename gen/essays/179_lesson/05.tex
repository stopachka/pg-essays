...
that the same test has to be given to large numbers of students.

{[}3{]} Learning is the naive algorithm for getting good grades.

{[}4{]} \href{gba.html}{Hacking} has multiple senses. There's a narrow
...
tests are hackable, they don't test what they're meant to.
...
the lack of authenticity in the people around him.
...
{[}9{]} Note that a good test is merely one that's unhackable. Good here
