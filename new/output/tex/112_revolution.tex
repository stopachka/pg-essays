...
The first is that startups may represent a \href{http://www.paulgraham.com/highres.html}{new economic phase}, on the scale of the Industrial Revolution. I'm not sure of this, but there seems a decent chance it's true.  People are dramatically more 
...
The second idea is that startups are a type of business that flourishes in certain places that \href{http://www.paulgraham.com/startuphubs.html}{specialize} in it---that Silicon Valley specializes in startups in the same way Los Angeles specializes in movies, or New York in finance. [\href{\#f1n}{1}]
...
\textbf{Thanks} to Patrick Collison, Jessica Livingston, and Fred Wilson for reading drafts of this.
