...
\href{http://store.yahoo.com}{Yahoo Store}, this
...
handed to \href{http://news.zdnet.co.uk/business/0,39020645,2077931,00.htm}{someone else} 
...
using \href{http://www.paulgraham.com/avg.html}{Lisp}, which many people still consider 
a research language,
...
you know are broken.  
\href{http://news.cnet.com/news/0-1006-200-5195914.html}{Apple} 
...
\href{http://store.yahoo.com/rtml.html}{RTML}, 
...
more than money.  As Fred Brooks pointed out in \emph{The Mythical
...
\href{https://sep.turbifycdn.com/ca/I/paulgraham\_1656\_3563}{side}, 
we made that an
...
was \href{http://www.bricklin.com/visicalc.htm}{VisiCalc}, the 
...
There were a few things we would have \emph{really} liked to add to
...
\href{http://en.wikipedia.org/wiki/Altair\_8800}{Altair},
...
hardware with an 
\href{http://news.cnet.com/news/0-1006-200-3622600.html}{online service}. 
...
in \href{http://www.paulgraham.com/avg.html}{Lisp}.
...
vigorously enforced.
[9] In \emph{No Logo,} Naomi Klein says that clothing brands favored by
...
\href{http://www.schwartz-pr.com}{PR firm} 
(admittedly
...
\textbf{Thanks} to Sarah Harlin, Trevor Blackwell, Robert Morris, Eric Raymond, Ken Anderson,
