...
\begin{enumerate}
\item  \textbf{Avoid distractions.}  Distractions are bad for many types of work,
...
\item  \textbf{Work in long stretches.}  Since there's a fixed cost each time
...
\item  \textbf{Use succinct languages.}  More 
   \href{http://www.paulgraham.com/power.html}{powerful} programming languages
...
\item  \textbf{Keep rewriting your program.}  Rewriting a program often yields
...
\item  \textbf{Write rereadable code.}  All programmers know it's good to write
...
\item  \textbf{Work in small groups.}  When you manipulate a program in your
...
\item  \textbf{Don't have multiple people editing the same piece of code.}  You
...
\item  \textbf{Start small.}  A program gets easier to hold in your head as you
...
small because the idea \emph{is} small at first; he just has some cool
hack he wants to try out.

Even more striking are the number of officially sanctioned projects
that manage to do \emph{all eight things wrong}.  In fact, if you look at
...
\href{http://www.paulgraham.com/hiring.html}{buy} them.  But regardless
...
\textbf{Thanks} to Sam Altman, David Greenspan, Aaron Iba, Jessica Livingston,
