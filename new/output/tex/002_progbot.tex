...
\emph{(This essay is from the introduction to }\href{http://www.paulgraham.com/onlisp.html}{On Lisp}\emph{.)}
...
called \emph{top-down design:} you say "the purpose of the
...
could be called \emph{bottom-up design}-- changing the language
to suit the problem.
...
\begin{enumerate}
\item  By making the language do more of the work, bottom-up design
...
\item  Bottom-up design promotes code re-use.
When you write two
...
\item  Bottom-up design makes programs easier to read.
...
\item  Because it causes you always to be on the lookout for patterns
...
group.  In \emph{The Mythical Man-Month},
Frederick Brooks
...
\href{http://www.paulgraham.com/avg.html}{win outright}.
