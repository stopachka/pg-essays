...
\begin{enumerate}
\item  There's an initial period of slow or no growth while the startup
  tries to figure out what it's doing.


\item  As the startup figures out how to make something lots of people
  want and how to reach those people, there's a period of rapid
  growth.


\item  Eventually a successful startup will grow into a big company.
...
starting a startup \emph{consists} of.  What you're really doing (and
...
[4]
I got it wrong in \href{http://www.paulgraham.com/wealth.html}{"How to Make Wealth"} when I said that a
